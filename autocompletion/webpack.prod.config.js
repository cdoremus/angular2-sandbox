 ...
 * Production build.
 *
 * 1. To setup the build, you make this change in autocompletion.service.ts:
 * const AUTOCOMPLETE_URL = '/autocompletion/users.json';
 *
 * 2. Build using this command:
 * webpack -p --config webpack.prod.config.js
 *
 * 3. Copy dist folder to cdoremus.github.io repo in the autocompletion folder
 *
 * 4. Commit changes and push them to github
 */

// Helper: root() are defined at the bottom
